...
docker run -d --net=bb-network --name bb-appserver-db -e POSTGRES_USER=postgres -e POSTGRES_DB=bblogic -e POSTGRES_PASSWORD=postgres -v /data:/var/lib/postgresql/data -d postgres
